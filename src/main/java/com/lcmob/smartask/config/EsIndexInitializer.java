 ...
 * 【索引结构】
 *   索引名：knowledge_base
 *   映射文件：src/main/resources/es-mappings/knowledge_base.json
 *
 * 【字段说明】
 *   - id：文档唯一标识
 *   - fileMd5：文件指纹
 *   - chunkId：分块序号
 *   - textContent：文本内容（用于BM25搜索）
 *   - vector：向量（用于KNN搜索，2048维）
 *   - userId、orgTag、isPublic：权限相关字段
 */
@Component
